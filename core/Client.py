...
class Client:
    ...
    def grad_d_out_d_x(self, hyper_param=None):
        ...
        for batch_idx, (images, labels) in enumerate(self.ldr_val):
            ...
            d_out_d_x += gather_flat_grad(
                grad(loss, get_trainable_hyper_params(hyper_param), create_graph=True)
            )
    ...
    def hyper_update(self, hg):
        ...
        return -gather_flat_hyper_params(self.hyper_param) + gather_flat_hyper_params(
